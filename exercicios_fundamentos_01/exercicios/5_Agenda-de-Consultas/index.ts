...
// id (número)
// patientName (string)
// date (string no formato ISO)
// isConfirmed (booleano)
// Crie uma função que liste apenas as consultas confirmadas.
